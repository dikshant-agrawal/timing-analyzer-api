...
***************************************/
#define RGB_PWM_red_Resolution                     (8u)
...
#define RGB_PWM_red_DeadBand2_4                    (0u)
    ...
    #define RGB_PWM_red_UseStatus                  (1u)
#else
...
#if (!RGB_PWM_red_UsingFixedFunction)
    uint8   RGB_PWM_red_ReadCounter(void) ;
    uint8 RGB_PWM_red_ReadCapture(void) ;

    #if (RGB_PWM_red_UseStatus)
            void RGB_PWM_red_ClearFIFO(void) ;
    #endif /* (RGB_PWM_red_UseStatus) */

    void    RGB_PWM_red_WriteCounter(uint8 counter)
            ;
#endif /* (!RGB_PWM_red_UsingFixedFunction) */

void    RGB_PWM_red_WritePeriod(uint8 period)
        ;
uint8 RGB_PWM_red_ReadPeriod(void) ;

#if (RGB_PWM_red_UseOneCompareMode)
    void    RGB_PWM_red_WriteCompare(uint8 compare)
            ;
    uint8 RGB_PWM_red_ReadCompare(void) ;
#else
    void    RGB_PWM_red_WriteCompare1(uint8 compare)
            ;
    uint8 RGB_PWM_red_ReadCompare1(void) ;
    void    RGB_PWM_red_WriteCompare2(uint8 compare)
            ;
    uint8 RGB_PWM_red_ReadCompare2(void) ;
#endif /* (RGB_PWM_red_UseOneCompareMode) */
...
**************************************/
#define RGB_PWM_red_INIT_PERIOD_VALUE          (100u)
#define RGB_PWM_red_INIT_COMPARE_VALUE1        (50u)
...
******************************** */
   ...
   #define RGB_PWM_red_RT1_PTR                 ( (reg8 *)  RGB_PWM_red_PWMHW__RT1)
       ...
       #if(RGB_PWM_red_PWMModeIsCenterAligned)
           #define RGB_PWM_red_PERIOD_LSB      (*(reg8 *)  RGB_PWM_red_PWMUDB_sP8_pwmdp_u0__D1_REG)
           #define RGB_PWM_red_PERIOD_LSB_PTR  ((reg8 *)   RGB_PWM_red_PWMUDB_sP8_pwmdp_u0__D1_REG)
       #else
           #define RGB_PWM_red_PERIOD_LSB      (*(reg8 *)  RGB_PWM_red_PWMUDB_sP8_pwmdp_u0__F0_REG)
           #define RGB_PWM_red_PERIOD_LSB_PTR  ((reg8 *)   RGB_PWM_red_PWMUDB_sP8_pwmdp_u0__F0_REG)
       #endif /* (RGB_PWM_red_PWMModeIsCenterAligned) */

       #define RGB_PWM_red_COMPARE1_LSB        (*(reg8 *)  RGB_PWM_red_PWMUDB_sP8_pwmdp_u0__D0_REG)
       #define RGB_PWM_red_COMPARE1_LSB_PTR    ((reg8 *)   RGB_PWM_red_PWMUDB_sP8_pwmdp_u0__D0_REG)
       #define RGB_PWM_red_COMPARE2_LSB        (*(reg8 *)  RGB_PWM_red_PWMUDB_sP8_pwmdp_u0__D1_REG)
       #define RGB_PWM_red_COMPARE2_LSB_PTR    ((reg8 *)   RGB_PWM_red_PWMUDB_sP8_pwmdp_u0__D1_REG)
       #define RGB_PWM_red_COUNTERCAP_LSB      (*(reg8 *)  RGB_PWM_red_PWMUDB_sP8_pwmdp_u0__A1_REG)
       #define RGB_PWM_red_COUNTERCAP_LSB_PTR  ((reg8 *)   RGB_PWM_red_PWMUDB_sP8_pwmdp_u0__A1_REG)
       #define RGB_PWM_red_COUNTER_LSB         (*(reg8 *)  RGB_PWM_red_PWMUDB_sP8_pwmdp_u0__A0_REG)
       #define RGB_PWM_red_COUNTER_LSB_PTR     ((reg8 *)   RGB_PWM_red_PWMUDB_sP8_pwmdp_u0__A0_REG)
       #define RGB_PWM_red_CAPTURE_LSB         (*(reg8 *)  RGB_PWM_red_PWMUDB_sP8_pwmdp_u0__F1_REG)
       #define RGB_PWM_red_CAPTURE_LSB_PTR     ((reg8 *)   RGB_PWM_red_PWMUDB_sP8_pwmdp_u0__F1_REG)

   #else
        #if(CY_PSOC3) /* 8-bit address space */
            #if(RGB_PWM_red_PWMModeIsCenterAligned)
               #define RGB_PWM_red_PERIOD_LSB      (*(reg16 *) RGB_PWM_red_PWMUDB_sP8_pwmdp_u0__D1_REG)
               #define RGB_PWM_red_PERIOD_LSB_PTR  ((reg16 *)  RGB_PWM_red_PWMUDB_sP8_pwmdp_u0__D1_REG)
            #else
               #define RGB_PWM_red_PERIOD_LSB      (*(reg16 *) RGB_PWM_red_PWMUDB_sP8_pwmdp_u0__F0_REG)
               #define RGB_PWM_red_PERIOD_LSB_PTR  ((reg16 *)  RGB_PWM_red_PWMUDB_sP8_pwmdp_u0__F0_REG)
            #endif /* (RGB_PWM_red_PWMModeIsCenterAligned) */

            #define RGB_PWM_red_COMPARE1_LSB       (*(reg16 *) RGB_PWM_red_PWMUDB_sP8_pwmdp_u0__D0_REG)
            #define RGB_PWM_red_COMPARE1_LSB_PTR   ((reg16 *)  RGB_PWM_red_PWMUDB_sP8_pwmdp_u0__D0_REG)
            #define RGB_PWM_red_COMPARE2_LSB       (*(reg16 *) RGB_PWM_red_PWMUDB_sP8_pwmdp_u0__D1_REG)
            #define RGB_PWM_red_COMPARE2_LSB_PTR   ((reg16 *)  RGB_PWM_red_PWMUDB_sP8_pwmdp_u0__D1_REG)
            #define RGB_PWM_red_COUNTERCAP_LSB     (*(reg16 *) RGB_PWM_red_PWMUDB_sP8_pwmdp_u0__A1_REG)
            #define RGB_PWM_red_COUNTERCAP_LSB_PTR ((reg16 *)  RGB_PWM_red_PWMUDB_sP8_pwmdp_u0__A1_REG)
            #define RGB_PWM_red_COUNTER_LSB        (*(reg16 *) RGB_PWM_red_PWMUDB_sP8_pwmdp_u0__A0_REG)
            #define RGB_PWM_red_COUNTER_LSB_PTR    ((reg16 *)  RGB_PWM_red_PWMUDB_sP8_pwmdp_u0__A0_REG)
            #define RGB_PWM_red_CAPTURE_LSB        (*(reg16 *) RGB_PWM_red_PWMUDB_sP8_pwmdp_u0__F1_REG)
            #define RGB_PWM_red_CAPTURE_LSB_PTR    ((reg16 *)  RGB_PWM_red_PWMUDB_sP8_pwmdp_u0__F1_REG)
        #else
            #if(RGB_PWM_red_PWMModeIsCenterAligned)
               #define RGB_PWM_red_PERIOD_LSB      (*(reg16 *) RGB_PWM_red_PWMUDB_sP8_pwmdp_u0__16BIT_D1_REG)
               #define RGB_PWM_red_PERIOD_LSB_PTR  ((reg16 *)  RGB_PWM_red_PWMUDB_sP8_pwmdp_u0__16BIT_D1_REG)
            #else
               #define RGB_PWM_red_PERIOD_LSB      (*(reg16 *) RGB_PWM_red_PWMUDB_sP8_pwmdp_u0__16BIT_F0_REG)
               #define RGB_PWM_red_PERIOD_LSB_PTR  ((reg16 *)  RGB_PWM_red_PWMUDB_sP8_pwmdp_u0__16BIT_F0_REG)
            #endif /* (RGB_PWM_red_PWMModeIsCenterAligned) */

            #define RGB_PWM_red_COMPARE1_LSB       (*(reg16 *) RGB_PWM_red_PWMUDB_sP8_pwmdp_u0__16BIT_D0_REG)
            #define RGB_PWM_red_COMPARE1_LSB_PTR   ((reg16 *)  RGB_PWM_red_PWMUDB_sP8_pwmdp_u0__16BIT_D0_REG)
            #define RGB_PWM_red_COMPARE2_LSB       (*(reg16 *) RGB_PWM_red_PWMUDB_sP8_pwmdp_u0__16BIT_D1_REG)
            #define RGB_PWM_red_COMPARE2_LSB_PTR   ((reg16 *)  RGB_PWM_red_PWMUDB_sP8_pwmdp_u0__16BIT_D1_REG)
            #define RGB_PWM_red_COUNTERCAP_LSB     (*(reg16 *) RGB_PWM_red_PWMUDB_sP8_pwmdp_u0__16BIT_A1_REG)
            #define RGB_PWM_red_COUNTERCAP_LSB_PTR ((reg16 *)  RGB_PWM_red_PWMUDB_sP8_pwmdp_u0__16BIT_A1_REG)
            #define RGB_PWM_red_COUNTER_LSB        (*(reg16 *) RGB_PWM_red_PWMUDB_sP8_pwmdp_u0__16BIT_A0_REG)
            #define RGB_PWM_red_COUNTER_LSB_PTR    ((reg16 *)  RGB_PWM_red_PWMUDB_sP8_pwmdp_u0__16BIT_A0_REG)
            #define RGB_PWM_red_CAPTURE_LSB        (*(reg16 *) RGB_PWM_red_PWMUDB_sP8_pwmdp_u0__16BIT_F1_REG)
            #define RGB_PWM_red_CAPTURE_LSB_PTR    ((reg16 *)  RGB_PWM_red_PWMUDB_sP8_pwmdp_u0__16BIT_F1_REG)
        #endif /* (CY_PSOC3) */

       #define RGB_PWM_red_AUX_CONTROLDP1          (*(reg8 *)  RGB_PWM_red_PWMUDB_sP8_pwmdp_u1__DP_AUX_CTL_REG)
       #define RGB_PWM_red_AUX_CONTROLDP1_PTR      ((reg8 *)   RGB_PWM_red_PWMUDB_sP8_pwmdp_u1__DP_AUX_CTL_REG)

   #endif /* (RGB_PWM_red_Resolution == 8) */

   #define RGB_PWM_red_COUNTERCAP_LSB_PTR_8BIT ( (reg8 *)  RGB_PWM_red_PWMUDB_sP8_pwmdp_u0__A1_REG)
   #define RGB_PWM_red_AUX_CONTROLDP0          (*(reg8 *)  RGB_PWM_red_PWMUDB_sP8_pwmdp_u0__DP_AUX_CTL_REG)
   #define RGB_PWM_red_AUX_CONTROLDP0_PTR      ((reg8 *)   RGB_PWM_red_PWMUDB_sP8_pwmdp_u0__DP_AUX_CTL_REG)
