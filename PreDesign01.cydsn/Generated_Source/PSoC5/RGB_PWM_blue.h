...
***************************************/
#define RGB_PWM_blue_Resolution                     (8u)
...
#define RGB_PWM_blue_DeadBand2_4                    (0u)
    ...
    #define RGB_PWM_blue_UseStatus                  (1u)
#else
...
#if (!RGB_PWM_blue_UsingFixedFunction)
    uint8   RGB_PWM_blue_ReadCounter(void) ;
    uint8 RGB_PWM_blue_ReadCapture(void) ;

    #if (RGB_PWM_blue_UseStatus)
            void RGB_PWM_blue_ClearFIFO(void) ;
    #endif /* (RGB_PWM_blue_UseStatus) */

    void    RGB_PWM_blue_WriteCounter(uint8 counter)
            ;
#endif /* (!RGB_PWM_blue_UsingFixedFunction) */

void    RGB_PWM_blue_WritePeriod(uint8 period)
        ;
uint8 RGB_PWM_blue_ReadPeriod(void) ;

#if (RGB_PWM_blue_UseOneCompareMode)
    void    RGB_PWM_blue_WriteCompare(uint8 compare)
            ;
    uint8 RGB_PWM_blue_ReadCompare(void) ;
#else
    void    RGB_PWM_blue_WriteCompare1(uint8 compare)
            ;
    uint8 RGB_PWM_blue_ReadCompare1(void) ;
    void    RGB_PWM_blue_WriteCompare2(uint8 compare)
            ;
    uint8 RGB_PWM_blue_ReadCompare2(void) ;
#endif /* (RGB_PWM_blue_UseOneCompareMode) */
...
**************************************/
#define RGB_PWM_blue_INIT_PERIOD_VALUE          (100u)
#define RGB_PWM_blue_INIT_COMPARE_VALUE1        (50u)
...
******************************** */
   ...
   #define RGB_PWM_blue_RT1_PTR                 ( (reg8 *)  RGB_PWM_blue_PWMHW__RT1)
       ...
       #if(RGB_PWM_blue_PWMModeIsCenterAligned)
           #define RGB_PWM_blue_PERIOD_LSB      (*(reg8 *)  RGB_PWM_blue_PWMUDB_sP8_pwmdp_u0__D1_REG)
           #define RGB_PWM_blue_PERIOD_LSB_PTR  ((reg8 *)   RGB_PWM_blue_PWMUDB_sP8_pwmdp_u0__D1_REG)
       #else
           #define RGB_PWM_blue_PERIOD_LSB      (*(reg8 *)  RGB_PWM_blue_PWMUDB_sP8_pwmdp_u0__F0_REG)
           #define RGB_PWM_blue_PERIOD_LSB_PTR  ((reg8 *)   RGB_PWM_blue_PWMUDB_sP8_pwmdp_u0__F0_REG)
       #endif /* (RGB_PWM_blue_PWMModeIsCenterAligned) */

       #define RGB_PWM_blue_COMPARE1_LSB        (*(reg8 *)  RGB_PWM_blue_PWMUDB_sP8_pwmdp_u0__D0_REG)
       #define RGB_PWM_blue_COMPARE1_LSB_PTR    ((reg8 *)   RGB_PWM_blue_PWMUDB_sP8_pwmdp_u0__D0_REG)
       #define RGB_PWM_blue_COMPARE2_LSB        (*(reg8 *)  RGB_PWM_blue_PWMUDB_sP8_pwmdp_u0__D1_REG)
       #define RGB_PWM_blue_COMPARE2_LSB_PTR    ((reg8 *)   RGB_PWM_blue_PWMUDB_sP8_pwmdp_u0__D1_REG)
       #define RGB_PWM_blue_COUNTERCAP_LSB      (*(reg8 *)  RGB_PWM_blue_PWMUDB_sP8_pwmdp_u0__A1_REG)
       #define RGB_PWM_blue_COUNTERCAP_LSB_PTR  ((reg8 *)   RGB_PWM_blue_PWMUDB_sP8_pwmdp_u0__A1_REG)
       #define RGB_PWM_blue_COUNTER_LSB         (*(reg8 *)  RGB_PWM_blue_PWMUDB_sP8_pwmdp_u0__A0_REG)
       #define RGB_PWM_blue_COUNTER_LSB_PTR     ((reg8 *)   RGB_PWM_blue_PWMUDB_sP8_pwmdp_u0__A0_REG)
       #define RGB_PWM_blue_CAPTURE_LSB         (*(reg8 *)  RGB_PWM_blue_PWMUDB_sP8_pwmdp_u0__F1_REG)
       #define RGB_PWM_blue_CAPTURE_LSB_PTR     ((reg8 *)   RGB_PWM_blue_PWMUDB_sP8_pwmdp_u0__F1_REG)

   #else
        #if(CY_PSOC3) /* 8-bit address space */
            #if(RGB_PWM_blue_PWMModeIsCenterAligned)
               #define RGB_PWM_blue_PERIOD_LSB      (*(reg16 *) RGB_PWM_blue_PWMUDB_sP8_pwmdp_u0__D1_REG)
               #define RGB_PWM_blue_PERIOD_LSB_PTR  ((reg16 *)  RGB_PWM_blue_PWMUDB_sP8_pwmdp_u0__D1_REG)
            #else
               #define RGB_PWM_blue_PERIOD_LSB      (*(reg16 *) RGB_PWM_blue_PWMUDB_sP8_pwmdp_u0__F0_REG)
               #define RGB_PWM_blue_PERIOD_LSB_PTR  ((reg16 *)  RGB_PWM_blue_PWMUDB_sP8_pwmdp_u0__F0_REG)
            #endif /* (RGB_PWM_blue_PWMModeIsCenterAligned) */

            #define RGB_PWM_blue_COMPARE1_LSB       (*(reg16 *) RGB_PWM_blue_PWMUDB_sP8_pwmdp_u0__D0_REG)
            #define RGB_PWM_blue_COMPARE1_LSB_PTR   ((reg16 *)  RGB_PWM_blue_PWMUDB_sP8_pwmdp_u0__D0_REG)
            #define RGB_PWM_blue_COMPARE2_LSB       (*(reg16 *) RGB_PWM_blue_PWMUDB_sP8_pwmdp_u0__D1_REG)
            #define RGB_PWM_blue_COMPARE2_LSB_PTR   ((reg16 *)  RGB_PWM_blue_PWMUDB_sP8_pwmdp_u0__D1_REG)
            #define RGB_PWM_blue_COUNTERCAP_LSB     (*(reg16 *) RGB_PWM_blue_PWMUDB_sP8_pwmdp_u0__A1_REG)
            #define RGB_PWM_blue_COUNTERCAP_LSB_PTR ((reg16 *)  RGB_PWM_blue_PWMUDB_sP8_pwmdp_u0__A1_REG)
            #define RGB_PWM_blue_COUNTER_LSB        (*(reg16 *) RGB_PWM_blue_PWMUDB_sP8_pwmdp_u0__A0_REG)
            #define RGB_PWM_blue_COUNTER_LSB_PTR    ((reg16 *)  RGB_PWM_blue_PWMUDB_sP8_pwmdp_u0__A0_REG)
            #define RGB_PWM_blue_CAPTURE_LSB        (*(reg16 *) RGB_PWM_blue_PWMUDB_sP8_pwmdp_u0__F1_REG)
            #define RGB_PWM_blue_CAPTURE_LSB_PTR    ((reg16 *)  RGB_PWM_blue_PWMUDB_sP8_pwmdp_u0__F1_REG)
        #else
            #if(RGB_PWM_blue_PWMModeIsCenterAligned)
               #define RGB_PWM_blue_PERIOD_LSB      (*(reg16 *) RGB_PWM_blue_PWMUDB_sP8_pwmdp_u0__16BIT_D1_REG)
               #define RGB_PWM_blue_PERIOD_LSB_PTR  ((reg16 *)  RGB_PWM_blue_PWMUDB_sP8_pwmdp_u0__16BIT_D1_REG)
            #else
               #define RGB_PWM_blue_PERIOD_LSB      (*(reg16 *) RGB_PWM_blue_PWMUDB_sP8_pwmdp_u0__16BIT_F0_REG)
               #define RGB_PWM_blue_PERIOD_LSB_PTR  ((reg16 *)  RGB_PWM_blue_PWMUDB_sP8_pwmdp_u0__16BIT_F0_REG)
            #endif /* (RGB_PWM_blue_PWMModeIsCenterAligned) */

            #define RGB_PWM_blue_COMPARE1_LSB       (*(reg16 *) RGB_PWM_blue_PWMUDB_sP8_pwmdp_u0__16BIT_D0_REG)
            #define RGB_PWM_blue_COMPARE1_LSB_PTR   ((reg16 *)  RGB_PWM_blue_PWMUDB_sP8_pwmdp_u0__16BIT_D0_REG)
            #define RGB_PWM_blue_COMPARE2_LSB       (*(reg16 *) RGB_PWM_blue_PWMUDB_sP8_pwmdp_u0__16BIT_D1_REG)
            #define RGB_PWM_blue_COMPARE2_LSB_PTR   ((reg16 *)  RGB_PWM_blue_PWMUDB_sP8_pwmdp_u0__16BIT_D1_REG)
            #define RGB_PWM_blue_COUNTERCAP_LSB     (*(reg16 *) RGB_PWM_blue_PWMUDB_sP8_pwmdp_u0__16BIT_A1_REG)
            #define RGB_PWM_blue_COUNTERCAP_LSB_PTR ((reg16 *)  RGB_PWM_blue_PWMUDB_sP8_pwmdp_u0__16BIT_A1_REG)
            #define RGB_PWM_blue_COUNTER_LSB        (*(reg16 *) RGB_PWM_blue_PWMUDB_sP8_pwmdp_u0__16BIT_A0_REG)
            #define RGB_PWM_blue_COUNTER_LSB_PTR    ((reg16 *)  RGB_PWM_blue_PWMUDB_sP8_pwmdp_u0__16BIT_A0_REG)
            #define RGB_PWM_blue_CAPTURE_LSB        (*(reg16 *) RGB_PWM_blue_PWMUDB_sP8_pwmdp_u0__16BIT_F1_REG)
            #define RGB_PWM_blue_CAPTURE_LSB_PTR    ((reg16 *)  RGB_PWM_blue_PWMUDB_sP8_pwmdp_u0__16BIT_F1_REG)
        #endif /* (CY_PSOC3) */

       #define RGB_PWM_blue_AUX_CONTROLDP1          (*(reg8 *)  RGB_PWM_blue_PWMUDB_sP8_pwmdp_u1__DP_AUX_CTL_REG)
       #define RGB_PWM_blue_AUX_CONTROLDP1_PTR      ((reg8 *)   RGB_PWM_blue_PWMUDB_sP8_pwmdp_u1__DP_AUX_CTL_REG)

   #endif /* (RGB_PWM_blue_Resolution == 8) */

   #define RGB_PWM_blue_COUNTERCAP_LSB_PTR_8BIT ( (reg8 *)  RGB_PWM_blue_PWMUDB_sP8_pwmdp_u0__A1_REG)
   #define RGB_PWM_blue_AUX_CONTROLDP0          (*(reg8 *)  RGB_PWM_blue_PWMUDB_sP8_pwmdp_u0__DP_AUX_CTL_REG)
   #define RGB_PWM_blue_AUX_CONTROLDP0_PTR      ((reg8 *)   RGB_PWM_blue_PWMUDB_sP8_pwmdp_u0__DP_AUX_CTL_REG)
